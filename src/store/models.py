...
class Bill(models.Model):
    ...
    def calculate_purchase_total(self):
        """Recalculate total based on related BillItems."""
    ...
    def calculate_paid_total(self):
        """Recalculate total paid based on related Payments."""
...
class BillItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Recalculate the bill total whenever an item is added/updated
...
class Payment(models.Model):
    ...
    def save(self, *args, **kwargs):
        super().save(*args, **kwargs)
        # Recalculate the total paid whenever a payment is added/updated
